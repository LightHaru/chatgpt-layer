...
The one-liner fetches `install.sh` from `main` (fail-closed lockfile); that script then pins downloaded source to tag `v1.1.3` unless `CODEX_PLUSPLUS_REF` is set.
