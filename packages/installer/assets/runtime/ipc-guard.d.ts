 ...
 */
export declare const PRIVILEGED_IPC_CHANNELS: readonly ["codexpp:install-store-tweak", "codexpp:install-github-tweak", "codexpp:prepare-tweak-store-submission", "codexpp:run-codexpp-update", "codexpp:set-auto-update", "codexpp:set-update-config", "codexpp:native-load-module", "codexpp:native-module-request", "codexpp:native-module-dispose", "codexpp:native-create-panel", "codexpp:native-attach-view", "codexpp:native-instance-call", "codexpp:native-launch-helper", "codexpp:native-helper-call", "codexpp:codex-window-create", "codexpp:codex-window-primary", "codexpp:codex-window-focus", "codexpp:codex-window-show", "codexpp:codex-view-create", "codexpp:codex-view-call", "codexpp:tweak-fs", "codexpp:codex-sessions-list", "codexpp:codex-sessions-status", "codexpp:copy-text", "codexpp:reveal"];
