...
export type { ClassifySpawnResult, DesktopSpawnApi, DesktopSpawnSeamStatus, DesktopStdioTransportMode, PathIo, SanitizedSpawnObservation, SpawnModule, } from "./types";
...
export declare function installDesktopAppServerSpawnProbe(options: CodexDesktopSpawnProbeOptions): CodexDesktopSpawnProbe;
