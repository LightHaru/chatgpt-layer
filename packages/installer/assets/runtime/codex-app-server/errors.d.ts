 ...
 */
export type CodexAppServerErrorKind = "malformed" | "oversized" | "timeout" | "child-exit" | "spawn" | "internal" | "unavailable" | "not-proven" | "closed" | "unsupported" | "invalid-id" | "protocol" | "store-corrupt" | "session-not-running" | "already-attached" | "not-running" | "owner-exists" | "missing-thread-id" | "fallback-required";
